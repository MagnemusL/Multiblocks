...
public class ModMenuTypes {
    public static final DeferredRegister<MenuType<?>> MENUS =
            DeferredRegister.create(ForgeRegistries.MENU_TYPES, MultiBlockMod.MODID);

    public static final RegistryObject<MenuType<MasterMenu>> MASTER_MENU = registerMenu(MasterMenu::new, "master_menu");
